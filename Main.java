...
class Morse {
    ...
    public String Decode(String a) {
        ...
        while (init < a.length()) {
            letter.setLength(0);
            while (init < a.length() && a.charAt(init) != ' ') {
    ...
    public String Encode(String b) {
        ...
        while (i < b.length()) {
            ...
            if (b.charAt(i) != ' ') {
                ...
                d.append(' ');
                d.append(' ');  // Double space for word separation
                d.append(' ');
            }
            i++;
        }
    ...
    public static void main(String[] args) {
        ...
        if (choice.equals("D")) {
            ...
            code = code + ' ';
            System.out.println("The message is : " + morse.Decode(code));
        } else if (choice.equals("E")) {
            System.out.println("Enter a sentence you want to Encode : ");
            String sent = sc.nextLine();
            System.out.println("The code is : " + morse.Encode(sent));
        } else {
